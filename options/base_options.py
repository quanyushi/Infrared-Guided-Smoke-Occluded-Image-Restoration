...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', required=True, help='path to images. Supports two structures: 1) Hierarchical: train/trainA, train/trainB, test/testA, test/testB 2) Flat: trainA, trainB, testA, testB')
